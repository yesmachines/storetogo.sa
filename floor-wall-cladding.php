...
<head>
	...
	<title>Van Floor & Wall Cladding Solutions | StoreToGoo KSA</title>
	<meta name="description" content="Protect and enhance your van’s interior with premium floor and wall cladding — impact-resistant panels, integrated lashing points, and easy installation.">
...
<section class="page-pro">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <h4><a href="index.php">Home</a> > Floor and wall cladding</h4>
      </div>
    </div>
  </div>
...
<div id="comp_00001AGM" class="sortimo-component text-component big-header
">
...
<hr>
                <p class="tile-text">
                The StoreToGo floor plate offers a simple and secure fastening option for StoreToGo van racking and also ensures that the value of the vehicle is maintained.</p>
              </div>
          </div>
        </div>
      </div>
  <div class="low single-tile wide ghdlndj" style="background-image: url('images/product/boden-wand-kacheln-wandverkleidung-690x340.jpg'); ">
...
<hr>
                <p class="tile-text">
                StoreToGo wall cladding makes it easy to install an SR5 shelf and offers a wide range of possible uses thanks to adaptable accessory options.</p>
              </div>
          </div>
        </div>
      </div>
...
<div class="row sty-wid1">
<div class="yCmsComponent sortimo-component-slot clearfix centet-all">
<div class="sortimo-component highlight-component" id="comp_000019LG" style="background-color: #eeeff1;color: #546373; fill: #546373;">
  <div class="text-image-container">
    ...
    <div class="image" style="background-image: url('images/product/boden-wand-produkthighlights.jpg');">
      <img src="images/product/boden-wand-produkthighlights.jpg" style="visibility: hidden;" alt="Van wall cladding in UAE">
    </div>
...
<div class="row sty-wid">
  <div class="yCmsComponent sortimo-component-slot clearfix">
<div id="comp_00001AK6" class="sortimo-component text-component big-header
">
  
      <h4 class="component-headline ">
        
        Double floor solutions
      </h4>
