...
<head>
  ...
  <title> Portable Shoulder Sink – Storetogo Saudi Arabia </title>

  <meta name="description" content="Stay hygienic on the go with the Shoulder Sink — a portable van-mounted hand-wash station with water, soap, and paper, from Storetogo Saudi Arabia.">
  ...
  <link rel="canonical" href="https://www.storetogoo.com/sa/shoulder-sink.php" />
...
<body>
  ...
  <section class="shoulder-sink-area">
    <div class="container">
      <div class="row">
        <!-- <div class="col-md-5 shoulder-one">
        ...
        <div class="col-md-12 shoulder-two">
          ...
          <ul>
            ...
            <li> <i class="fa fa-long-arrow-right" aria-hidden="true"></i> Carpenters </li>
            <li> <i class="fa fa-long-arrow-right" aria-hidden="true"></i> Road service assistance </li>
...
<div id="accordion">
  ...
  <div class="accordion">
    <input type="radio" name="radacc" class="accordian-chk" />
    <h3 class="accordian-header">
    <span class="nmbr"> 3. </span>	What are the key features of a van hand wash station?
      <span class="acc-icon"></span>
    </h3>
    <div class="accordian-content">
