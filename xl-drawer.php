...
<!--***************************************-->
	...
	<title>XL Under-floor Drawer – Storetogo Saudi Arabia</title>
	<meta name="description" content="Maximize van cargo space in Saudi Arabia with the Storetogo XL under-floor drawer — high-capacity, ergonomic, and built for heavy-duty use.">
	<link rel="shortcut icon" href="images/favicon.png">
	<meta charset="utf-8">
	<meta name="keywords" content="">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="canonical" href="https://www.storetogoo.com/sa/xl-drawer.php" />
...
<section class="page-pro">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <h4><a href="index.php">Home</a> > Jumbo Unit - the compact XL drawer from StoreToGo</h4>
      </div>
    </div>
  </div>
...
<div class="sortimo-component wide-image text-picture-component wide-image-left" id="comp_000019MH">
  <div class="row" style="background-color: #eeeff1;">
    <div class="image-container" style="width: 1050px; height: 510px;
        background-image: url('images/product/grossraumschublade-header-1050x510.jpg');  float: left;">
        <img src="images/product/grossraumschublade-header-1050x510.jpg" style="visibility: hidden;">
      </div>  
...
<div class="text">
  ...
  <section id="serico-hg">
    <div class="container-fluid">
      <div class="row styd">
    <div class="yCmsComponent sortimo-component-slot clearfix">
<div id="comp_000019MI" class="sortimo-component text-component big-header
">
...
<div class="row sty-wid1">
  <div class="yCmsComponent sortimo-component-slot clearfix">
<div id="comp_000019N6" class="sortimo-component text-component 
">
...
<section id="lalla">
    <div class="container-fluid">
      <div class="row sty-wid1">
       <div class="yCmsComponent sortimo-component-slot clearfix">
<div id="comp_000019MM" class="sortimo-component text-component big-header
">
      ...
      <h4 class="component-headline subheadline">
      ...
      <div class="yCmsComponent sortimo-component-slot clearfix">
<div class="sortimo-component highlight-component" id="comp_000019MK" style="background-color: #eeeff1;color: #546373; fill: #546373;">
  <div class="text-image-container">
    ...
    <div class="image" style="background-image: url('images/product/grossraumschublade-produkthighlights.gif');">
      <img src="images/product/grossraumschublade-produkthighlights.gif" style="visibility: hidden;">
    </div>
