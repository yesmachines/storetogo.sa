...
<!--***************************************-->
	...
	<title>C-BOXX 17 L Storage Box | StoreToGoo Saudi Arabia</title>
	<meta name="description" content="Shop the C-BOXX at StoreToGoo KSA — a rugged 17 L box with a transparent lid, fold-down handle, and full ProClick / van-racking compatibility.">
	<link rel="shortcut icon" href="images/favicon.png">
	<meta charset="utf-8">
	<meta name="keywords" content="">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="canonical" href="https://www.storetogoo.com/sa/C-BOXX.php" />
...
<section class="page-pro">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <h4><a href="index.php">Home</a> > <a href="#">BOXXes & Cases</a> > C-BOXX</h4>
      </div>
    </div>
  </div>
    ...
    <div class="categoryHeader ">
      <div class="categoryHeaderTexts">
        <div class="categoryHeaderTeaser">
          <p class="calk">C-BOXX.<br>The universal.</p></div>
        <div class="categoryHeaderText">
          <p class="calktev">The C-BOXX is a robust transport solution for lots of activities in trade, industry and service. Thanks to its bucket-like design, it can be used universally for storing tools and consumables or even for transporting dirty used parts. The transparent lid seals the C-BOXX and protects the contents.</p></div>
      </div>
...
<div class="product__listing product__grid">
  ...
  <div>
    <a class="thumb" href="" title="C-BOXX with cover"> 
        <img src="images/product/6000013614-C-BOXX-mit-Deckel-Produktbild-leer.jpg" alt="C-BOXX with cover" title="C-BOXX with cover">
      </a>
      <div class="details">

        <a class="name cutText" href="" title="C-BOXX with cover">
            C-BOXX with cover</a>
        <div class="artnr">
            Ref. No.: 6000013614</div>
